...
enum BonusQuestionBank {
    ...
    static func pool(for topic: Topic) -> [BankQuestion] {
        ...
        case .soccer, .dinosaurs, .space, .animals, .sea, .gifted, .food, .israel, .music, .body, .vehicles, .flags, .tishrei, .holidays: return []   // packs and language-only worlds — their hard tier serves as bonus
    ...
    static let english: [BankQuestion] = [
        BankQuestion(prompt: "🦋\nאֵיךְ אוֹמְרִים אֶת זֶה בְּאַנְגְּלִית?", correctAnswer: "butterfly", distractors: ["dragonfly", "ladybug", "caterpillar"], tier: .hard, grades: 3...5),
        BankQuestion(prompt: "☂️\nאֵיךְ אוֹמְרִים אֶת זֶה בְּאַנְגְּלִית?", correctAnswer: "umbrella", distractors: ["raincoat", "shadow", "shelter"], tier: .hard, grades: 3...5),
        BankQuestion(prompt: "אֵיךְ אוֹמְרִים \"מִשְׁקָפַיִם\" בְּאַנְגְּלִית?", correctAnswer: "glasses", distractors: ["windows", "mirrors", "bottles"], tier: .hard, grades: 3...5),
        BankQuestion(prompt: "אֵיךְ אוֹמְרִים \"בְּקָרוֹב\" בְּאַנְגְּלִית?", correctAnswer: "soon", distractors: ["late", "never", "always"], tier: .hard, grades: 3...5),
        BankQuestion(prompt: "מָה הַהֵפֶךְ שֶׁל \"empty\"?", correctAnswer: "full", distractors: ["open", "heavy", "clean"], tier: .hard, grades: 3...5),
        BankQuestion(prompt: "מָה הַהֵפֶךְ שֶׁל \"expensive\"?", correctAnswer: "cheap", distractors: ["rich", "small", "easy"], tier: .hard, grades: 4...6),
    ...
    static let science: [BankQuestion] = [
        ...
        BankQuestion(prompt: "מִי מֵהֶם יוֹנֵק?", correctAnswer: "דּוֹלְפִין", distractors: ["כָּרִישׁ", "תַּנִּין", "צְפַרְדֵּעַ"], tier: .hard, grades: 3...5),
        BankQuestion(prompt: "כַּמָּה זְמַן לוֹקֵחַ לְכַדּוּר הָאָרֶץ לְהַשְׁלִים סִבּוּב סְבִיב הַשֶּׁמֶשׁ?", correctAnswer: "שָׁנָה", distractors: ["יוֹם", "חֹדֶשׁ", "שָׁבוּעַ"], tier: .hard, grades: 2...4),
        BankQuestion(prompt: "מָה הַמַּצָּב שֶׁל הַמַּיִם בְּקֶרַח?", correctAnswer: "מוּצָק", distractors: ["נוֹזֵל", "גַּז", "פְּלַסְמָה"], tier: .hard, grades: 2...4),
    ]

    // MARK: - היסטוריה

    static let history: [BankQuestion] = [
        BankQuestion(prompt: "בְּאֵיזוֹ שָׁנָה קָמָה מְדִינַת יִשְׂרָאֵל?", correctAnswer: "1948", distractors: ["1918", "1967", "1938"], tier: .hard, grades: 3...5),
        BankQuestion(prompt: "מִי הָיָה רֹאשׁ הַמֶּמְשָׁלָה הָרִאשׁוֹן שֶׁל יִשְׂרָאֵל?", correctAnswer: "דָּוִד בֶּן־גּוּרְיוֹן", distractors: ["חַיִּים וַיְצְמַן", "גּוֹלְדָּה מֵאִיר", "מְנַחֵם בֵּגִין"], tier: .hard, grades: 2...4),
        BankQuestion(prompt: "אֵיזֶה עַם בָּנָה אֶת הַפִּירָמִידוֹת?", correctAnswer: "הַמִּצְרִים הַקַּדְמוֹנִים", distractors: ["הָרוֹמָאִים", "הַיְּוָנִים", "הַבַּבְלִים"], tier: .hard, grades: 3...5),
        BankQuestion(prompt: "מִי הָיָה הָאָדָם הָרִאשׁוֹן שֶׁדָּרַךְ עַל הַיָּרֵחַ?", correctAnswer: "נִיל אַרְמְסְטְרוֹנְג", distractors: ["יוּרִי גָּגָרִין", "בָּאז אוֹלְדְרִין", "אַלְבֶּרְט אַיְנְשְׁטַיְן"], tier: .hard, grades: 4...6),
        BankQuestion(prompt: "אֵיךְ קָרְאוּ לַכְּתָב שֶׁל הַמִּצְרִים הַקַּדְמוֹנִים?", correctAnswer: "כְּתַב חַרְטֻמִּים", distractors: ["כְּתַב יְתֵדוֹת", "אָלֶף־בֵּית", "כְּתַב סִינִי"], tier: .hard, grades: 5...6),
    ...
    static let geography: [BankQuestion] = [
        BankQuestion(prompt: "מָה עִיר הַבִּירָה שֶׁל יַפָּן?", correctAnswer: "טוֹקְיוֹ", distractors: ["בֵּיגִ'ין", "סֵאוּל", "בַּנְגְקוֹק"], tier: .hard, grades: 4...6),
        ...
        BankQuestion(prompt: "בְּאֵיזוֹ מְדִינָה נִמְצָא מִגְדַּל אַיְפֶל?", correctAnswer: "צָרְפַת", distractors: ["אִיטַלְיָה", "סְפָרַד", "אַנְגְּלִיָּה"], tier: .hard, grades: 2...4),
        BankQuestion(prompt: "אֵיזוֹ מְדִינָה הִיא גַּם יַבֶּשֶׁת שְׁלֵמָה?", correctAnswer: "אוֹסְטְרַלְיָה", distractors: ["הֹדּוּ", "בְּרָזִיל", "רוּסְיָה"], tier: .hard, grades: 4...6),
    ]
    ...
    static let money: [BankQuestion] = [
        ...
        BankQuestion(prompt: "מָה זֶה \"חִסָּכוֹן\"?", correctAnswer: "כֶּסֶף שֶׁשּׁוֹמְרִים לֶעָתִיד בִּמְקוֹם לְבַזְבֵּז", distractors: ["כֶּסֶף שֶׁמּוֹצִיאִים מַהֵר", "מַתָּנָה מֵחֲבֵרִים", "סוּג שֶׁל מַטְבֵּעַ"], tier: .hard, grades: 1...3),
        ...
        BankQuestion(prompt: "לָמָּה כְּדַאי לְהַשְׁווֹת מְחִירִים לִפְנֵי שֶׁקּוֹנִים?", correctAnswer: "כְּדֵי לִמְצֹא אֶת אוֹתוֹ מוּצָר בְּזוֹל יוֹתֵר", distractors: ["כְּדֵי לְבַזְבֵּז יוֹתֵר זְמַן", "כִּי זֶה חוֹבָה עַל פִּי חֹק", "כְּדֵי לִקְנוֹת כַּמָּה שֶׁיּוֹתֵר"], tier: .hard, grades: 2...4),
        BankQuestion(prompt: "מָה עוֹשֶׂה הַבַּנְק בַּכֶּסֶף שֶׁחוֹסְכִים אֶצְלוֹ?", correctAnswer: "שׁוֹמֵר אוֹתוֹ וְנוֹתֵן עָלָיו רִבִּית", distractors: ["מְבַזְבֵּז אוֹתוֹ", "זוֹרֵק אוֹתוֹ", "מַחְלִיף אוֹתוֹ בְּמַמְתַּקִּים"], tier: .hard, grades: 4...6),
        BankQuestion(prompt: "בַּאֲרוּחָה: פִּיצָה בְּ־28 שְׁקָלִים וְשֵׁתִיָּה בְּ־7. כַּמָּה בְּיַחַד?", correctAnswer: "35 שְׁקָלִים", distractors: ["33 שְׁקָלִים", "37 שְׁקָלִים", "38 שְׁקָלִים"], tier: .hard, grades: 2...4),
    ]
}
