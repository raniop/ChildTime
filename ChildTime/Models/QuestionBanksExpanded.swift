...
enum QuestionBanksExpanded {
    ...
    static let logic: [BankQuestion] = [
        ...
        BankQuestion(prompt: "אֲנִי כָּתֹם בַּחוּץ וְיָרֹק לְמַעְלָה. מִי אֲנִי?", correctAnswer: "גֶּזֶר", distractors: ["תַּפּוּחַ", "מְלָפְפוֹן", "תַּפּוּז"]),
    ...
    static let science: [BankQuestion] = [
        ...
        BankQuestion(prompt: "💧\nכַּמָּה אָחוּז מִכַּדּוּר הָאָרֶץ מְכֻסֶּה בְּמַיִם?", correctAnswer: "כ-71%", distractors: ["20%", "50%", "100%"]),
        ...
        BankQuestion(prompt: "🦴\nכַּמָּה עֲצָמוֹת יֵשׁ בְּגוּף מְבֻגָּר?", correctAnswer: "206", distractors: ["150", "100", "300"]),
    ...
    static let geography: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🇦🇪\nמַה בִּירַת אִיחוּד הָאֱמִירֻיּוֹת?", correctAnswer: "אַבּוּ דָאבִּי", distractors: ["דּוּבַּאי", "שַׁארְגָּ'ה", "עַגְ'מָאן"]),
        ...
        BankQuestion(prompt: "🇮🇱\nאֵיזֶה יָם נִמְצָא בִּדְרוֹם יִשְׂרָאֵל?", correctAnswer: "יָם סוּף", distractors: ["הַיָּם הַתִּיכוֹן", "יָם הַמֶּלַח", "הַיָּם הַשָּׁחֹר"]),
