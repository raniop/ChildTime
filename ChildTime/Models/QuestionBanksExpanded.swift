...
enum QuestionBanksExpanded {
    ...
    static let english: [BankQuestion] = [
        ...
        BankQuestion(prompt: "לִקְפּוֹץ בְּאַנְגְּלִית?", correctAnswer: "jump", distractors: ["run", "fly", "climb"]),
        BankQuestion(prompt: "לֶאֱכוֹל בְּאַנְגְּלִית?", correctAnswer: "eat", distractors: ["drink", "sleep", "cook"]),
        BankQuestion(prompt: "לִישׁוֹן בְּאַנְגְּלִית?", correctAnswer: "sleep", distractors: ["eat", "play", "rest"]),
        BankQuestion(prompt: "לִקְרוֹא בְּאַנְגְּלִית?", correctAnswer: "read", distractors: ["write", "look", "listen"]),
        BankQuestion(prompt: "לִכְתּוֹב בְּאַנְגְּלִית?", correctAnswer: "write", distractors: ["read", "draw", "speak"]),
        ...
        BankQuestion(prompt: "לִשְׁמוֹעַ בְּאַנְגְּלִית?", correctAnswer: "hear", distractors: ["see", "say", "listen"]),
        ...
        BankQuestion(prompt: "אוֹזֶן בְּאַנְגְּלִית?", correctAnswer: "ear", distractors: ["eye", "nose", "head"]),
        ...
        BankQuestion(prompt: "What does 'red' mean?", correctAnswer: "אָדוֹם", distractors: ["כָּחוֹל", "יָרוֹק", "וָרוֹד"]),
        BankQuestion(prompt: "What does 'happy' mean?", correctAnswer: "שָׂמֵחַ", distractors: ["עָצוּב", "כּוֹעֵס", "עָיֵף"]),
        BankQuestion(prompt: "What does 'big' mean?", correctAnswer: "גָּדוֹל", distractors: ["קָטָן", "אָרוֹךְ", "רָחָב"]),
        BankQuestion(prompt: "What does 'small' mean?", correctAnswer: "קָטָן", distractors: ["גָּדוֹל", "צַר", "קָצָר"]),
        BankQuestion(prompt: "What does 'fast' mean?", correctAnswer: "מָהִיר", distractors: ["אִיטִּי", "חָזָק", "אָרוֹךְ"]),
    ...
    static let logic: [BankQuestion] = [
        ...
        BankQuestion(prompt: "מִי לֹא שַׁיָּךְ?", correctAnswer: "שׁוּלְחָן", distractors: ["כֶּלֶב", "חָתוּל", "אַרְיֵה"]),
        ...
        BankQuestion(prompt: "מִי לֹא שַׁיָּךְ?", correctAnswer: "אָדוֹם", distractors: ["שָׁלוֹשׁ", "חָמֵשׁ", "שֶׁבַע"]),
        ...
        // Riddles
        BankQuestion(prompt: "אֲנִי שׁוֹתֶה אֲבָל לֹא כּוֹס. מָה אֲנִי?", correctAnswer: "צֶמַח", distractors: ["שׁוּלְחָן", "חַלּוֹן", "סֵפֶר"]),
        BankQuestion(prompt: "יֵשׁ לִי אַרְבַּע רַגְלַיִם אֲבָל לֹא הוֹלֵךְ. מִי אֲנִי?", correctAnswer: "שׁוּלְחָן", distractors: ["סוּס", "כֶּלֶב", "צָב"]),
        ...
        BankQuestion(prompt: "אֲנִי כָּתוֹם בַּחוּץ וְיָרוֹק לְמַעְלָה. מִי אֲנִי?", correctAnswer: "גֶּזֶר", distractors: ["תַּפּוּחַ", "מְלָפְפוֹן", "תַּפּוּז"]),
        BankQuestion(prompt: "יֵשׁ לִי דַּפִּים אֲבָל לֹא עֵץ. מִי אֲנִי?", correctAnswer: "סֵפֶר", distractors: ["צֶמַח", "פֶּרַח", "פֵּרוֹת"]),

        // Categories
        BankQuestion(prompt: "מַה זֶה לֹא צֶבַע?", correctAnswer: "שׁוּלְחָן", distractors: ["אָדוֹם", "כָּחוֹל", "יָרוֹק"]),
        ...
        // Mirror/reverse
        BankQuestion(prompt: "מַה הַהֵפֶךְ שֶׁל 'גָּדוֹל'?", correctAnswer: "קָטָן", distractors: ["אָרוֹךְ", "רָחָב", "גָּבוֹהַּ"]),
        BankQuestion(prompt: "מַה הַהֵפֶךְ שֶׁל 'חַם'?", correctAnswer: "קַר", distractors: ["טָעִים", "מָתוֹק", "יָבֵשׁ"]),
        BankQuestion(prompt: "מַה הַהֵפֶךְ שֶׁל 'מָהִיר'?", correctAnswer: "אִיטִּי", distractors: ["חָזָק", "אָרוֹךְ", "כָּבֵד"]),
        BankQuestion(prompt: "מַה הַהֵפֶךְ שֶׁל 'יוֹם'?", correctAnswer: "לַיְלָה", distractors: ["בּוֹקֶר", "עֶרֶב", "צָהֳרַיִם"]),
        BankQuestion(prompt: "מַה הַהֵפֶךְ שֶׁל 'שָׂמֵחַ'?", correctAnswer: "עָצוּב", distractors: ["מַצְחִיק", "רָגוּעַ", "מְבוּלְבָּל"]),
    ...
    static let science: [BankQuestion] = [
        BankQuestion(prompt: "🌱\nמַה צְמָחִים צְרִיכִים כְּדֵי לִגְדּוֹל?", correctAnswer: "שֶׁמֶשׁ, מַיִם וַאֲדָמָה", distractors: ["אֲוִיר וְעוּגָה", "חוֹל בִּלְבַד", "שֶׁלֶג בִּלְבַד"]),
        BankQuestion(prompt: "💧\nכַּמָּה אָחוּז מִכַּדּוּר הָאָרֶץ מְכוּסֶּה בְּמַיִם?", correctAnswer: "כ-71%", distractors: ["20%", "50%", "100%"]),
        ...
        BankQuestion(prompt: "🌍\nכַּמָּה לוּחוֹת טֶקְטוֹנִיִּים יֵשׁ?", correctAnswer: "7 גְּדוֹלִים", distractors: ["3", "2", "20"]),
        BankQuestion(prompt: "🦴\nכַּמָּה עֲצָמוֹת יֵשׁ בְּגוּף מְבוּגָּר?", correctAnswer: "206", distractors: ["150", "100", "300"]),
        BankQuestion(prompt: "👀\nכַּמָּה צְבָעִים יֵשׁ בַּקֶּשֶׁת?", correctAnswer: "7", distractors: ["5", "6", "10"]),
        BankQuestion(prompt: "🐅\nאֵיזֶה אֵיבָר מַשְׁאִיב אֶת הַדָּם?", correctAnswer: "הַלֵּב", distractors: ["הָרֵאוֹת", "הַכָּבֵד", "הַמּוֹחַ"]),
        BankQuestion(prompt: "🌬️\nבְּאֵיזֶה חוֹמֶר אֲנַחְנוּ נוֹשְׁמִים?", correctAnswer: "חַמְצָן", distractors: ["מֵימָן", "פַּחְמָן", "אוֹזוֹן"]),
        ...
        BankQuestion(prompt: "🔴\nאֵיזֶה כּוֹכַב לֶכֶת אָדוֹם?", correctAnswer: "מַאְדִּים", distractors: ["נוֹגַהּ", "צֶדֶק", "שַׁבְּתַאי"]),
        ...
        BankQuestion(prompt: "❄️\nמַה הַתְּכוּנָה שֶׁל קֶרַח?", correctAnswer: "קַר וְקָשֶׁה", distractors: ["חַם וְרַךְ", "שָׁקוּף וְנוֹזְלִי", "צָהוֹב וְרֵיחָנִי"]),
        BankQuestion(prompt: "🔥\nמַה אֵשׁ צְרִיכָה כְּדֵי לִדְלוֹק?", correctAnswer: "חַמְצָן וְדֶלֶק", distractors: ["מַיִם בִּלְבַד", "חוֹל", "קוֹר"]),
        ...
        BankQuestion(prompt: "🌱\nאֵיזֶה חֵלֶק בַּצֶּמַח שׁוֹאֵב מַיִם?", correctAnswer: "הַשּׁוֹרֶשׁ", distractors: ["הֶעָלֶה", "הַפֶּרַח", "הַגֶּזַע"]),
        BankQuestion(prompt: "☀️\nאֵיזֶה חֵלֶק בַּצֶּמַח מְיַצֵּר אֶנֶרְגְּיָה מֵהַשֶּׁמֶשׁ?", correctAnswer: "הֶעָלֶה", distractors: ["הַשּׁוֹרֶשׁ", "הַפֶּרַח", "הָאֲדָמָה"]),
        BankQuestion(prompt: "💪\nמַה הֲכִי חָזָק בַּגּוּף?", correctAnswer: "הַשְּׁרִירִים", distractors: ["הָעוֹר", "הַשֵּׂעָר", "הַצִּפָּרְנַיִם"]),
        BankQuestion(prompt: "🦷\nכַּמָּה שִׁנַּיִם יֵשׁ לִמְבוּגָּר?", correctAnswer: "32", distractors: ["20", "28", "40"]),
        BankQuestion(prompt: "🧠\nאֵיזֶה אֵיבָר חוֹשֵׁב?", correctAnswer: "הַמּוֹחַ", distractors: ["הַלֵּב", "הַכָּבֵד", "הָרֵאוֹת"]),
        ...
        BankQuestion(prompt: "🐋\nאֵיזוֹ חַיָּה הֲכִי גְּדוֹלָה בָּעוֹלָם?", correctAnswer: "לִוְיָתָן כָּחוֹל", distractors: ["פִּיל", "כָּרִישׁ", "גִּ'ירָפָה"]),
        BankQuestion(prompt: "🐆\nאֵיזוֹ חַיָּה הֲכִי מְהִירָה?", correctAnswer: "בַּרְדְּלָס", distractors: ["סוּס", "נָמֵר", "אַרְיֵה"]),
        BankQuestion(prompt: "⚡\nאֵיךְ נִקְרָא רַעַם וּבָרָק יַחַד?", correctAnswer: "סוּפַת רְעָמִים", distractors: ["סוּפַת חוֹל", "טוֹרְנָדוֹ", "סוּפָה יְרוּקָּה"]),
        ...
        BankQuestion(prompt: "💎\nאֵיזֶה חוֹמֶר הֲכִי קָשֶׁה בַּטֶּבַע?", correctAnswer: "יַהֲלוֹם", distractors: ["בַּרְזֶל", "אֶבֶן", "זְכוּכִית"]),
        ...
        BankQuestion(prompt: "🐦\nמָה מְאַפְשֵׁר לַצִּפּוֹר לָעוּף?", correctAnswer: "כְּנָפַיִם", distractors: ["שִׁנַּיִם", "זָנָב", "פַּרְוָה"]),
        ...
        BankQuestion(prompt: "🌍\nאֵיזֶה כּוֹחַ מוֹשֵׁךְ אוֹתָנוּ לָאֲדָמָה?", correctAnswer: "כּוֹחַ הַכּוֹבֶד", distractors: ["מַגְנֵט", "רוּחַ", "אוֹר"]),
    ]
    ...
    static let history: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🎺\nמַה גָּרַם לְחוֹמוֹת יְרִיחוֹ לִנְפּוֹל?", correctAnswer: "תְּרוּעַת הַשּׁוֹפָר", distractors: ["רְעִידַת אֲדָמָה", "סוּפַת חוֹל", "מַבּוּל"]),
        ...
        BankQuestion(prompt: "📜\nמַה הַשָּׂפָה הָעִקָּרִית שֶׁל הַתַּנַ\"ךְ?", correctAnswer: "עִבְרִית", distractors: ["יְוָונִית", "אֲרָמִית", "עֲרָבִית"]),
        ...
        BankQuestion(prompt: "👵\nמִי הָיְתָה רֹאשַׁת הַמֶּמְשָׁלָה הָרִאשׁוֹנָה?", correctAnswer: "גּוֹלְדָּה מֵאִיר", distractors: ["שׁוּלַמִּית אַלוֹנִי", "צִיפִּי לִבְנִי", "מִירִי רֶגֶב"]),
        ...
        BankQuestion(prompt: "🎼\nמִי כָּתַב אֶת הַיְּצִירָה 'מוּזִיקַת לַיְלָה זְעִירָה'?", correctAnswer: "מוֹצַרְט", distractors: ["בֵּטְהוֹבֶן", "בָּאךְ", "שׁוֹפֵּן"]),
        ...
        BankQuestion(prompt: "🌌\nמִי גִּילָּה אֶת כּוֹחַ הַכּוֹבֶד?", correctAnswer: "נְיוּטוֹן", distractors: ["אַיינְשְׁטַיין", "גָּלִילֵאוֹ", "קוֹפֶּרְנִיקוּס"]),
        ...
        BankQuestion(prompt: "📜\nאֵיזֶה סִפּוּר נֶחְשָׁב עַתִּיק מְאוֹד?", correctAnswer: "אֶפּוֹס גִּלְגָּמֶשׁ", distractors: ["הַתַּנַ\"ךְ", "הָאוֹדִיסֵאָה", "הָאִילִיאָדָה"]),
        BankQuestion(prompt: "🏯\nאֵיפֹה בָּנוּ אֶת הַחוֹמָה הַסִּינִית הַגְּדוֹלָה?", correctAnswer: "סִין", distractors: ["יָפָאן", "קוֹרֵאָה", "הוֹדּוּ"]),
        ...
        BankQuestion(prompt: "🇮🇱\nמַה הָיָה הַשֵּׁם שֶׁל אֶרֶץ יִשְׂרָאֵל לִפְנֵי 1948?", correctAnswer: "פָּלֶשְׂתִּינָה (תַּחַת הַמַּנְדָּט)", distractors: ["יִשְׂרָאֵל", "אֶרֶץ הַקּוֹדֶשׁ", "כְּנַעַן"]),
        BankQuestion(prompt: "🇮🇱\nמַה תַּפְקִיד הַנָּשִׂיא בְּיִשְׂרָאֵל?", correctAnswer: "יִצּוּגִי", distractors: ["מְנַהֵל הַמְּדִינָה", "מְפַקֵּד הַצָּבָא", "רֹאשׁ בֵּית הַמִּשְׁפָּט"]),
        ...
        BankQuestion(prompt: "🎖️\nאֵיזֶה צֶבַע הַבֶּרֶט שֶׁל חֵיל הָאֲוִיר?", correctAnswer: "כָּחוֹל", distractors: ["אָדוֹם", "שָׁחוֹר", "יָרוֹק"]),
    ]
    ...
    static let geography: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🇮🇳\nמַה בִּירַת הוֹדּוּ?", correctAnswer: "נְיוּ דֶּלְהִי", distractors: ["מוּמְבַּאי", "בַּנְגָּלוֹר", "כַּלְכּוּתָּה"]),
        ...
        BankQuestion(prompt: "🇦🇪\nמַה בִּירַת אִיחוּד הָאֱמִירוּיּוֹת?", correctAnswer: "אַבּוּ דָאבִּי", distractors: ["דּוּבַּאי", "שַׁארְגָּ'ה", "עַגְ'מָאן"]),
        BankQuestion(prompt: "🇰🇷\nמַה בִּירַת קוֹרֵאָה הַדְּרוֹמִית?", correctAnswer: "סֵאוּל", distractors: ["בּוּסָאן", "אִינְצֶ'ון", "פְּיוֹנְגְיָאנְג"]),

        // Israel
        BankQuestion(prompt: "🇮🇱\nמַה הַיָּם הַמָּלוּחַ בְּיוֹתֵר בְּיִשְׂרָאֵל?", correctAnswer: "יָם הַמֶּלַח", distractors: ["הַכִּנֶּרֶת", "הַיָּם הַתִּיכוֹן", "יָם סוּף"]),
        ...
        BankQuestion(prompt: "🇮🇱\nמַה הַנָּהָר הָאָרוֹךְ בְּיִשְׂרָאֵל?", correctAnswer: "הַיַּרְדֵּן", distractors: ["הַיַּרְקוֹן", "הַקִּישׁוֹן", "הָאָלֶכְּסַנְדֶּר"]),
        BankQuestion(prompt: "🇮🇱\nאֵיזוֹ עִיר נִמְצֵאת קָרוֹב לְיָם הַמֶּלַח?", correctAnswer: "עֲרָד", distractors: ["נָצְרַת", "צְפַת", "אֵילַת"]),
        ...
        BankQuestion(prompt: "🇮🇱\nאֵיזֶה יָם נִמְצָא בִּדְרוֹם יִשְׂרָאֵל?", correctAnswer: "יָם סוּף", distractors: ["הַיָּם הַתִּיכוֹן", "יָם הַמֶּלַח", "הַיָּם הַשָּׁחוֹר"]),
        ...
        BankQuestion(prompt: "🌊\nאֵיזֶה אוֹקְיָנוֹס הוּא הַגָּדוֹל בְּיוֹתֵר?", correctAnswer: "הַשָּׁקֵט", distractors: ["הָאַטְלַנְטִי", "הַהוֹדִּי", "הָאַרְקְטִי"]),
        ...
        BankQuestion(prompt: "🦒\nאֵיזוֹ יַבֶּשֶׁת הִיא הֲכִי חַמָּה (מְמוּצָּע)?", correctAnswer: "אַפְרִיקָה", distractors: ["אַסְיָה", "אוֹסְטְרַלְיָה", "אֲמֵרִיקָה"]),
        ...
        BankQuestion(prompt: "🕌\nמֶרְכַּז הַתְּפִילָּה לְמוּסְלְמִים?", correctAnswer: "מֶכָּה", distractors: ["מְדִינָה", "יְרוּשָׁלַיִם", "קָהִיר"]),
        ...
        // Rivers & lakes
        BankQuestion(prompt: "🌊\nאֵיזֶה נָהָר הוּא הָאָרוֹךְ בְּיוֹתֵר בְּאַפְרִיקָה?", correctAnswer: "הַנִּילוּס", distractors: ["הַקּוֹנְגּוֹ", "הַנִּיזֶ'ר", "הַזַּמְבֶּזִי"]),
        BankQuestion(prompt: "🌊\nאֵיזֶה נָהָר הוּא הָאָרוֹךְ בְּיוֹתֵר בִּדְרוֹם אֲמֵרִיקָה?", correctAnswer: "הָאַמָזוֹנַס", distractors: ["הַפָּרָאנָה", "הַפָּרָגוּאַי", "הָאוֹרִינוֹקוֹ"]),
        BankQuestion(prompt: "🌊\nאֵיזֶה נָהָר הוּא הָאָרוֹךְ בְּיוֹתֵר בְּאֵירוֹפָּה?", correctAnswer: "הַוֹּולְגָּה", distractors: ["הַדָּנוּבָּה", "הָרַיין", "הַסֵּיינָה"]),
        BankQuestion(prompt: "🏔️\nאֵיזֶה הַר נִמְצָא בְּצָרְפַת?", correctAnswer: "מוֹן בְּלָאן", distractors: ["הָאֶוֶורֶסְט", "הַהִימָלָאיָה", "הָאַנְדִּים"]),
