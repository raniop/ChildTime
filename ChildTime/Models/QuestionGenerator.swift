...
struct QuestionGenerator {
    ...
    static func generate(topic: Topic, difficulty: Difficulty, grade: Int? = nil) -> Question {
        ...
        case .english, .hebrew, .logic, .science, .history, .geography, .money, .soccer, .dinosaurs, .space, .animals, .sea, .gifted, .food, .israel, .music, .body, .vehicles, .flags, .tishrei, .holidays:
