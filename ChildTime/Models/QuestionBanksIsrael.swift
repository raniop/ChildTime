...
enum QuestionBanksIsrael {
    static let israel: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🚗\nאֵיזוֹ אַפְּלִיקַצְיַת נִוּוּט מְפֻרְסֶמֶת פֻּתְּחָה בְּיִשְׂרָאֵל?", correctAnswer: "Waze", distractors: ["גּוּגְל מַפּוֹת", "יוּטְיוּבּ", "טִיקְטוֹק"], tier: .medium, grades: 3...5),
        BankQuestion(prompt: "🍅\nאֵיזֶה סוּג עַגְבָנִיָּה זָכָה לְפִתּוּחִים חַקְלָאִיִּים חֲשׁוּבִים בְּיִשְׂרָאֵל?", correctAnswer: "עַגְבָנִיּוֹת שֶׁרִי", distractors: ["עַגְבָנִיּוֹת מִן הַשָּׂדֶה", "עַגְבָנִיּוֹת יְרֻקּוֹת", "עַגְבָנִיּוֹת בָּר"], tier: .medium, grades: 3...5),
        ...
        BankQuestion(prompt: "🚇\nבְּאֵיזוֹ עִיר נוֹסַעַת \"הַכַּרְמֶלִית\"?", correctAnswer: "חֵיפָה", distractors: ["תֵּל אָבִיב", "יְרוּשָׁלַיִם", "בְּאֵר שֶׁבַע"], tier: .hard, grades: 4...6),
        ...
        BankQuestion(prompt: "💾\nאֵיזֶה מַכְשִׁיר קָטָן לְאִחְסוּן קְבָצִים, שֶׁמְּחַבְּרִים לַמַּחְשֵׁב, פֻּתַּח בְּיִשְׂרָאֵל?", correctAnswer: "דִּיסְק־אוֹן־קִי", distractors: ["הָעַכְבָּר", "הַמַּדְפֶּסֶת", "הַמִּקְלֶדֶת"], tier: .hard, grades: 4...6),
