...
enum QuestionBanks {
    ...
    static let science: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🦷\nאֵיךְ נִקְרָא הַחֹמֶר הַקָּשֶׁה שֶׁמְּכַסֶּה אֶת הַשֵּׁן?", correctAnswer: "אֱמַייְל", distractors: ["סֻכָּר", "סִיד", "בַּרְזֶל"]),
        BankQuestion(prompt: "🚀\nאֵיךְ נִקְרָא הַכּוֹכָב הָאָדֹם?", correctAnswer: "מַאְדִּים", distractors: ["צֶדֶק", "שַׁבְּתַאי", "נוֹגַהּ"]),
    ...
    static let hebrew: [BankQuestion] = [
        ...
        BankQuestion(prompt: "אֵיזוֹ מִלָּה הִיא שֵׁם שֶׁל צֶבַע?",       correctAnswer: "אָדֹם",     distractors: ["שֻׁלְחָן", "מָהִיר", "גָּדוֹל"]),
    ...
    static let money: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🐷\nמָה עוֹשִׂים בְּקֻפַּת חִסָּכוֹן?", correctAnswer: "שָׂמִים בָּהּ כֶּסֶף לֶעָתִיד", distractors: ["שׁוֹמְרִים בָּהּ מַמְתַּקִּים", "מְמַלְּאִים אוֹתָהּ בְּמַיִם", "שָׂמִים אוֹתָהּ עַל הַמַּדָּף לְקִשּׁוּט"]),
        ...
        BankQuestion(prompt: "💝\nחָבֵר שָׁכַח לְהָבִיא כֶּסֶף לְאֹכֶל. מָה נֶחְמָד לַעֲשׂוֹת?", correctAnswer: "לְשַׁתֵּף אוֹתוֹ בָּאֹכֶל שֶׁלִּי", distractors: ["לְהִתְעַלֵּם", "לֶאֱכֹל לְבַד בְּשֶׁקֶט", "לֶאֱכֹל מַהֵר"]),
