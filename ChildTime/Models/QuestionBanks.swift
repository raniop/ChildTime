...
enum QuestionBanks {
    ...
    static let money: [BankQuestion] = [
        ...
        BankQuestion(prompt: "💝\nחָבֵר שָׁכַח כֶּסֶף לְאֹכֶל. מָה נֶחְמָד לַעֲשׂוֹת?", correctAnswer: "לְשַׁתֵּף אוֹתוֹ בָּאֹכֶל שֶׁלִּי", distractors: ["לְהִתְעַלֵּם", "לֶאֱכֹל לְבַד בְּשֶׁקֶט", "לֶאֱכֹל מַהֵר"]),
