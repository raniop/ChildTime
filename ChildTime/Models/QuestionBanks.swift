...
enum QuestionBanks {
    ...
    static let logic: [BankQuestion] = [
        ...
        BankQuestion(prompt: "מָה בָּא אַחֲרֵי?\n🐶🐱🐶🐱🐶?", correctAnswer: "🐱", distractors: ["🐶", "🐭", "🐰"], grades: 0...2),
        BankQuestion(prompt: "מָה לֹא שַׁיָּךְ?", correctAnswer: "🚗", distractors: ["🐶", "🐱", "🐰"], grades: 0...2),
        BankQuestion(prompt: "מָה לֹא שַׁיָּךְ?", correctAnswer: "🍎", distractors: ["🚗", "🚌", "🚲"], grades: 0...2),
        BankQuestion(prompt: "מָה לֹא שַׁיָּךְ?", correctAnswer: "📖", distractors: ["⚽", "🏀", "🎾"], grades: 0...2),
        BankQuestion(prompt: "מָה לֹא שַׁיָּךְ?", correctAnswer: "🌳", distractors: ["☀️", "🌙", "⭐"], grades: 0...2),
    ...
    static let science: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🦋\nלְמָה הוֹפֵךְ זַחַל?", correctAnswer: "לְפַרְפַּר", distractors: ["לִדְבוֹרָה", "לְצִיפּוֹר", "לְעַכָּבִישׁ"], grades: 0...2),
    ...
    static let history: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🇺🇸\nאֵיזוֹ יַבֶּשֶׁת גִּילָּה קוֹלוּמְבּוּס?", correctAnswer: "אָמֵרִיקָה", distractors: ["אַפְרִיקָה", "אוֹסְטְרַלְיָה", "אַסְיָה"], grades: 4...6),
    ...
    static let money: [BankQuestion] = [
        ...
        BankQuestion(prompt: "📋\nמָה זֶה 'תַּקְצִיב'?", correctAnswer: "תָּכְנִית שֶׁקּוֹבַעַת כַּמָּה כֶּסֶף מֻתָּר לְהוֹצִיא", distractors: ["סוּג שֶׁל מַמְתָּק", "מִשְׂחָק קוּפְסָה", "סוּג שֶׁל מַטְבֵּעַ"], grades: 4...6),
