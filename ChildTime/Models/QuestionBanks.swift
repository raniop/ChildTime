...
enum QuestionBanks {
    ...
    static let science: [BankQuestion] = [
        ...
        BankQuestion(prompt: "❄️\nמָה קוֹרֶה לַמַּיִם בַּקּוֹר?", correctAnswer: "קוֹפְאִים", distractors: ["מִתְאַדִּים", "נֶעֱלָמִים", "מִתְחַמְּמִים"]),
        BankQuestion(prompt: "🌡️\nאֵיךְ מוֹדְדִים חוֹם?", correctAnswer: "בְּמַדְחוֹם", distractors: ["בְּמִשְׁקָל", "בְּסַרְגֵּל", "בְּשָׁעוֹן"]),
        BankQuestion(prompt: "🦷\nכַּמָּה שִׁנַּיִם יֵשׁ לְאָדָם מְבוּגָּר?", correctAnswer: "32", distractors: ["20", "28", "40"]),
        BankQuestion(prompt: "🦴\nכַּמָּה יָמִים יֵשׁ בַּשָּׁנָה?", correctAnswer: "365", distractors: ["360", "350", "400"]),
        BankQuestion(prompt: "🌙\nכַּמָּה זְמַן לוֹקֵחַ לַיָּרֵחַ לְהַקִּיף אֶת כַּדּוּר הָאָרֶץ?", correctAnswer: "כְּחוֹדֶשׁ", distractors: ["יוֹם", "שָׁנָה", "שָׁבוּעַ"]),
        ...
        BankQuestion(prompt: "🦷\nאֵיךְ נִקְרָא הַחוֹמֶר הַקָּשֶׁה שֶׁמְּכַסֶּה אֶת הַשֵּׁן?", correctAnswer: "אֱמַייְל", distractors: ["סוּכָּר", "סִיד", "בַּרְזֶל"]),
        BankQuestion(prompt: "🚀\nאֵיךְ נִקְרָא הַכּוֹכָב הָאָדוֹם?", correctAnswer: "מַאְדִּים", distractors: ["צֶדֶק", "שַׁבְּתַאי", "נוֹגַהּ"]),
        BankQuestion(prompt: "🧠\nאֵיזֶה אֵיבָר עוֹזֵר לָנוּ לַחְשׁוֹב?", correctAnswer: "הַמּוֹחַ", distractors: ["הַלֵּב", "הַקֵּבָה", "הָרֵאוֹת"])
    ]
    ...
    static let history: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🕯️\nבְּאֵיזֶה חַג מַדְלִיקִים נֵרוֹת 8 יָמִים?", correctAnswer: "חֲנוּכָּה", distractors: ["פֶּסַח", "סוּכּוֹת", "פּוּרִים"]),
        ...
        BankQuestion(prompt: "🏺\nמָה מָצְאוּ הַמַּכַּבִּים שֶׁהָיָה בּוֹ שֶׁמֶן לְיוֹם אֶחָד בִּלְבַד?", correctAnswer: "פַּךְ שֶׁמֶן", distractors: ["מַצָּה", "שׁוֹפָר", "סֵפֶר"]),
    ...
    static let geography: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🐼\nאֵיפֹה חַיּוֹת פַּנְדּוֹת?", correctAnswer: "סִין", distractors: ["יָפָן", "אוֹסְטְרַלְיָה", "הוֹדּוּ"]),
        BankQuestion(prompt: "🦘\nאֵיפֹה חַיִּים קֶנְגּוּרוּ?", correctAnswer: "אוֹסְטְרַלְיָה", distractors: ["אַפְרִיקָה", "אָמֵרִיקָה", "אֵירוֹפָּה"]),
        BankQuestion(prompt: "🐧\nאֵיפֹה חַיִּים פִּינְגְּוִוינִים?", correctAnswer: "בְּאַנְטַרְקְטִיקָה", distractors: ["בַּיָּם הַתִּיכוֹן", "בְּאַפְרִיקָה", "בְּאָמֵרִיקָה"]),
        ...
        BankQuestion(prompt: "🏞️\nמָה הַנָּהָר הָאָרוֹךְ בְּיוֹתֵר בָּעוֹלָם?", correctAnswer: "הַנִּילוּס", distractors: ["הַיַּרְדֵּן", "הָאָמָזוֹנָס", "הַמִּיסִיסִיפִּי"]),
        BankQuestion(prompt: "🌍\nכַּמָּה יַבָּשׁוֹת יֵשׁ בָּעוֹלָם?", correctAnswer: "7", distractors: ["5", "6", "8"]),
        BankQuestion(prompt: "🐘\nאֵיפֹה חַיִּים פִּילִים?", correctAnswer: "בְּאַפְרִיקָה וּבְהוֹדּוּ", distractors: ["בְּיִשְׂרָאֵל", "בְּאוֹסְטְרַלְיָה", "בְּאַנְטַרְקְטִיקָה"]),
    ...
    static let hebrew: [BankQuestion] = [
        ...
        BankQuestion(prompt: "מָה הַהֵפֶךְ מִ'יוֹם'?",    correctAnswer: "לַיְלָה",  distractors: ["בּוֹקֶר", "אוֹר", "שֶׁמֶשׁ"]),
        ...
        // קטגוריות
        BankQuestion(prompt: "אֵיזוֹ מִלָּה הִיא שֵׁם שֶׁל בַּעַל חַיִּים?", correctAnswer: "פִּיל",     distractors: ["כִּסֵּא", "דֶּלֶת", "עִפָּרוֹן"]),
        BankQuestion(prompt: "אֵיזוֹ מִלָּה הִיא שֵׁם שֶׁל פְּרִי?",       correctAnswer: "בָּנָנָה",   distractors: ["כִּסֵּא", "מְכוֹנִית", "נַעַל"]),
        BankQuestion(prompt: "אֵיזוֹ מִלָּה הִיא שֵׁם שֶׁל צֶבַע?",       correctAnswer: "אָדוֹם",     distractors: ["שׁוּלְחָן", "מָהִיר", "גָּדוֹל"]),
    ...
    static let money: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🍦\nיֵשׁ לְךָ 10 ₪ וּגְלִידָה עוֹלָה 6 ₪. כַּמָּה עוֹדֶף תְּקַבֵּל?", correctAnswer: "4 ₪", distractors: ["2 ₪", "3 ₪", "5 ₪"]),
        BankQuestion(prompt: "💵\nאֵיזֶה שְׁטָר שָׁוֶה הֲכִי הַרְבֵּה?", correctAnswer: "200 ₪", distractors: ["20 ₪", "50 ₪", "100 ₪"]),
        BankQuestion(prompt: "🐷\nמָה עוֹשִׂים בְּקוּפַּת חִסָּכוֹן?", correctAnswer: "שָׂמִים בָּהּ כֶּסֶף לֶעָתִיד", distractors: ["שׁוֹמְרִים בָּהּ מַמְתַּקִּים", "מְמַלְּאִים אוֹתָהּ בְּמַיִם", "שָׂמִים אוֹתָהּ עַל הַמַּדָּף לְקִשּׁוּט"]),
        BankQuestion(prompt: "🛒\nרוֹצִים לִקְנוֹת צַעֲצוּעַ יָקָר. מָה כְּדַאי לַעֲשׂוֹת?", correctAnswer: "לַחְסוֹךְ קְצָת כָּל שָׁבוּעַ", distractors: ["לְבַזְבֵּז הַכֹּל מִיָּד", "לְבַקֵּשׁ עוֹד וְעוֹד", "לֹא לַחְשׁוֹב עַל זֶה"]),
        BankQuestion(prompt: "🥤\nמַה מֵאֵלֶּה הוּא 'צוֹרֶךְ' חָשׁוּב?", correctAnswer: "אוֹכֶל וּמַיִם", distractors: ["צַעֲצוּעַ חָדָשׁ", "מַדְבֵּקוֹת", "מִשְׂחָק בַּטֶּלֶפוֹן"]),
        BankQuestion(prompt: "🪙🪙\n2 מַטְבְּעוֹת שֶׁל 5 ₪ — כַּמָּה זֶה?", correctAnswer: "10 ₪", distractors: ["7 ₪", "12 ₪", "15 ₪"]),
        BankQuestion(prompt: "🛍️\nקָנִיתָ בְּ-12 ₪ וְשִׁלַּמְתָּ עִם שְׁטָר שֶׁל 20 ₪. כַּמָּה עוֹדֶף?", correctAnswer: "8 ₪", distractors: ["6 ₪", "7 ₪", "10 ₪"]),
        BankQuestion(prompt: "💳\nמָה זֶה כַּרְטִיס אַשְׁרַאי?", correctAnswer: "דֶּרֶךְ לְשַׁלֵּם בְּלִי מְזוּמָּן", distractors: ["צַעֲצוּעַ", "כַּרְטִיס לְמִשְׂחָק", "תְּמוּנָה"]),
        BankQuestion(prompt: "🏷️\nאֵיזֶה מוּצָר זוֹל יוֹתֵר — בְּ-8 ₪ אוֹ בְּ-12 ₪?", correctAnswer: "8 ₪", distractors: ["12 ₪", "שְׁנֵיהֶם שָׁוִים", "אִי אֶפְשָׁר לָדַעַת"]),
        BankQuestion(prompt: "💝\nחָבֵר שָׁכַח לְהָבִיא כֶּסֶף לְאוֹכֶל. מָה נֶחְמָד לַעֲשׂוֹת?", correctAnswer: "לְשַׁתֵּף אוֹתוֹ בָּאוֹכֶל שֶׁלִּי", distractors: ["לְהִתְעַלֵּם", "לֶאֱכוֹל לְבַד בְּשֶׁקֶט", "לֶאֱכוֹל מַהֵר"]),
        ...
        BankQuestion(prompt: "🏦\nאֵיפֹה מְבוּגָּרִים שׁוֹמְרִים כֶּסֶף בְּבִטָּחוֹן?", correctAnswer: "בַּבַּנְק", distractors: ["בָּרְחוֹב", "בַּפַּח", "בָּעֵץ"]),
        BankQuestion(prompt: "🎁\nחָסַכְתָּ 50 ₪ וְהַמַּתָּנָה עוֹלָה 80 ₪. כַּמָּה עוֹד צָרִיךְ?", correctAnswer: "30 ₪", distractors: ["20 ₪", "40 ₪", "50 ₪"]),
        BankQuestion(prompt: "♻️\nאֵיךְ אֶפְשָׁר לַחְסוֹךְ כֶּסֶף בַּבַּיִת?", correctAnswer: "לְכַבּוֹת אוֹר שֶׁלֹּא צְרִיכִים", distractors: ["לְהַשְׁאִיר הַכֹּל דָּלוּק", "לִזְרוֹק אוֹכֶל", "לִקְנוֹת כָּפוּל"]),
