...
enum QuestionBanksGifted {
    static let gifted: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🪞\nאִילָן עוֹמֵד מוּל מַרְאָה וּמֵרִים אֶת יַד יָמִין. אֵיזוֹ יָד נִרְאֵית מוּרֶמֶת אֵצֶל הַדְּמוּת שֶׁבַּמַּרְאָה?", correctAnswer: "יַד שְׂמֹאל", distractors: ["יַד יָמִין", "שְׁתֵּי הַיָּדַיִם", "אַף יָד"], tier: .medium, grades: 3...4),
        ...
        BankQuestion(prompt: "🚗\nבַּחֲנָיָה 3 מְכוֹנִיּוֹת וְ־4 זוּגוֹת אוֹפַנַּיִם. כַּמָּה גַּלְגַּלִּים יֵשׁ בְּסַךְ הַכֹּל?", correctAnswer: "20", distractors: ["14", "16", "24"], tier: .medium, grades: 3...4),
        BankQuestion(prompt: "🔢\nכַּמָּה מִסְפָּרִים בֵּין 1 לְ־20 מִתְחַלְּקִים בְּ־5 בְּלִי שְׁאֵרִית?", correctAnswer: "4", distractors: ["2", "3", "5"], tier: .medium, grades: 3...4),
        ...
        BankQuestion(prompt: "📄\nמְקַפְּלִים דַּף לִשְׁנַיִם וְשׁוּב לִשְׁנַיִם, וּמְנַקְּבִים חוֹר אֶחָד בְּאֶמְצַע הַדַּף הַמְקֻפָּל. כַּמָּה חוֹרִים יֵשׁ בַּדַּף כְּשֶׁפּוֹתְחִים אוֹתוֹ?", correctAnswer: "4", distractors: ["1", "2", "8"], tier: .hard, grades: 4...5),
