...
enum QuestionBanksGifted {
    static let gifted: [BankQuestion] = [
        ...
        BankQuestion(prompt: "📄\nמְקַפְּלִים דַּף לִשְׁנַיִם וְגוֹזְרִים אֶת הַפִּנָּה שֶׁבַּקִּפּוּל. כְּשֶׁפּוֹתְחִים אֶת הַדַּף, אֵיזוֹ צוּרָה יֵשׁ בְּאֶמְצָעוֹ?", correctAnswer: "חוֹר בְּצוּרַת מְעֻיָּן", distractors: ["חוֹר עָגֹל", "שְׁנֵי חוֹרִים", "בְּלִי חוֹר"], tier: .hard, grades: 4...5),
