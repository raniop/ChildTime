...
enum QuestionBanksVehicles {
    static let vehicles: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🚂\nאֵיךְ קוֹרְאִים לָרֶכֶב שֶׁבְּרֹאשׁ הָרַכֶּבֶת וּמוֹשֵׁךְ אֶת כָּל הַקְּרוֹנוֹת?", correctAnswer: "קַטָּר", distractors: ["קָרוֹן", "סִירָה", "מַשָּׂאִית"], tier: .medium, grades: 1...3),
        ...
        BankQuestion(prompt: "🇮🇱\nבְּאֵיזוֹ עִיר נָסְעָה הָרַכֶּבֶת הַקַּלָּה הָרִאשׁוֹנָה בְּיִשְׂרָאֵל?", correctAnswer: "יְרוּשָׁלַיִם", distractors: ["אֵילַת", "טְבֶרְיָה", "צְפַת"], tier: .medium, grades: 1...3),
        ...
        BankQuestion(prompt: "🔌\nמַה צָרִיךְ לַעֲשׂוֹת כְּדֵי שֶׁמְּכוֹנִית חַשְׁמַלִּית תּוּכַל לִנְסֹעַ?", correctAnswer: "לְהַטְעִין אוֹתָהּ בְּחַשְׁמַל", distractors: ["לְמַלֵּא בֶּנְזִין", "לְמַלֵּא מַיִם", "לְדַוֵּשׁ בָּרַגְלַיִם"], tier: .medium, grades: 1...3),
        ...
        BankQuestion(prompt: "🌿\nלָמָּה מְכוֹנִית חַשְׁמַלִּית טוֹבָה לָאֲוִיר שֶׁאֲנַחְנוּ נוֹשְׁמִים?", correctAnswer: "אֵין לָהּ פְּלִיטוֹת מֵהָאַגְזוֹז בִּזְמַן הַנְּסִיעָה", distractors: ["הִיא יוֹתֵר גְּדוֹלָה", "יֵשׁ לָהּ יוֹתֵר גַּלְגַּלִּים", "הִיא צוֹפֶרֶת יוֹתֵר"], tier: .medium, grades: 1...3),
        ...
        BankQuestion(prompt: "🚄\nבֵּין אֵילוּ עָרִים נוֹסֵעַ הַקַּו הַמָּהִיר לִירוּשָׁלַיִם?", correctAnswer: "תֵּל אָבִיב וִירוּשָׁלַיִם", distractors: ["אֵילַת וְחֵיפָה", "צְפַת וּטְבֶרְיָה", "אַשְׁדּוֹד וְאַשְׁקְלוֹן"], tier: .hard, grades: 2...3),
