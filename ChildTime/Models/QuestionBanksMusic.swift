...
enum QuestionBanksMusic {
    static let music: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🔔\nמְצִלְתַּיִם הֵם שְׁנֵי לוּחוֹת מַתֶּכֶת עֲגֻלִּים. אֵיךְ מְנַגְּנִים בָּהֶם?", correctAnswer: "מַכִּים אוֹתָם זֶה בָּזֶה", distractors: ["נוֹשְׁפִים לְתוֹכָם", "פּוֹרְטִים עֲלֵיהֶם", "לוֹחֲצִים עַל קְלִידִים"], tier: .medium, grades: 1...3),
        ...
        BankQuestion(prompt: "🔊\nבְּמוּזִיקָה, מַה פֵּרוּשׁ הַמִּלָּה \"פוֹרְטֶה\"?", correctAnswer: "לְנַגֵּן חָזָק", distractors: ["לְנַגֵּן חֶרֶשׁ", "לְנַגֵּן מַהֵר", "לְנַגֵּן לְאַט"], tier: .hard, grades: 3...4),
