...
extension EnglishContent {
    static let music: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🎻\nWhich instrument looks like a violin but is bigger and is played sitting down?", correctAnswer: "Cello", distractors: ["Flute", "Tuba", "Harp"], tier: .medium, grades: 2...4),
        ...
        BankQuestion(prompt: "🪗\nWhich instrument has keys and is played by squeezing and stretching it with your hands?", correctAnswer: "Accordion", distractors: ["Piano", "Flute", "Drum"], tier: .medium, grades: 1...3),
