...
extension EnglishContent {
    static let dinosaurs: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🏞️\nWhere did most dinosaurs live?", correctAnswer: "On land", distractors: ["In the ocean", "In the air", "Underground"], tier: .medium, grades: 2...4),
        ...
        BankQuestion(prompt: "👣\nWhat can we learn from dinosaur footprints?", correctAnswer: "How the dinosaur walked and how big it was", distractors: ["What color the dinosaur was", "What the dinosaur's name was", "What sound the dinosaur made"], tier: .medium, grades: 3...4),
        ...
        BankQuestion(prompt: "📏\nA T. rex was about 40 feet long and a Triceratops about 30 feet long. How long are they end to end?", correctAnswer: "70 feet", distractors: ["10 feet", "60 feet", "80 feet"], tier: .medium, grades: 2...3),
        ...
        BankQuestion(prompt: "✖️\nA Stegosaurus has 4 spikes on its tail. How many tail spikes do 3 Stegosauruses have?", correctAnswer: "12", distractors: ["7", "8", "16"], tier: .medium, grades: 2...4),
