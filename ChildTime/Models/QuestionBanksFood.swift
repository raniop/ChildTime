...
enum QuestionBanksFood {
    static let food: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🫧\nאֵיזֶה גַּז יוֹצְרִים הַשְּׁמָרִים בַּבָּצֵק, שֶׁגּוֹרֵם לוֹ לִתְפֹּחַ?", correctAnswer: "פַּחְמָן דּוּ־חַמְצָנִי", distractors: ["חַמְצָן", "הֶלְיוּם", "חַנְקָן"], tier: .hard, grades: 4...5),
        ...
        BankQuestion(prompt: "🥛\nאֵיךְ קוֹרְאִים לְחִמּוּם הֶחָלָב בַּמַּחְלָבָה, שֶׁהוֹפֵךְ אוֹתוֹ לְבָטוּחַ לִשְׁתִיָּה?", correctAnswer: "פִּסְטוּר", distractors: ["טִגּוּן", "הַקְפָּאָה", "אֲפִיָּה"], tier: .hard, grades: 4...5),
