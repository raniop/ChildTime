...
enum ReadingContent {
    ...
    static let passages: [ReadingPassage] = [
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "אֵיךְ קוֹרְאִים לַחֲתוּלָה?", correctAnswer: "לוּנָה", distractors: ["מִיכַל", "שֶׁמֶשׁ", "חַמָּה"], tier: .easy),
                BankQuestion(prompt: "אֵיפֹה לוּנָה אוֹהֶבֶת לִישׁוֹן?", correctAnswer: "עַל הַגַּג", distractors: ["בַּמִּטָּה", "בַּגִּנָּה", "עַל הַסַּפָּה"], tier: .easy),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "בְּאֵיזֶה צֶבַע הַכַּדּוּר?", correctAnswer: "אָדֹם", distractors: ["כָּחֹל", "יָרֹק", "צָהֹב"], tier: .easy),
                BankQuestion(prompt: "עִם מִי שִׂחֵק יוֹנָתָן?", correctAnswer: "עִם אָחִיו הַקָּטָן", distractors: ["עִם אַבָּא", "עִם חָבֵר מֵהַגַּן", "לְבַד"], tier: .easy),
                BankQuestion(prompt: "לָמָּה יוֹנָתָן קִבֵּל כַּדּוּר?", correctAnswer: "לְיוֹם הַהֻלֶּדֶת", distractors: ["כִּי נִצֵּחַ בְּמִשְׂחָק", "לַחֲנֻכָּה", "סְתָם, בְּלִי סִבָּה"], tier: .easy),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מָה יָרַד בַּחוּץ?", correctAnswer: "גֶּשֶׁם", distractors: ["שֶׁלֶג", "בָּרָד", "עָלִים"], tier: .easy),
                BankQuestion(prompt: "מָה נָעֲלָה נֹעָה?", correctAnswer: "מַגָּפַיִם וְרֻדִּים", distractors: ["סַנְדָּלִים", "נַעֲלֵי סְפּוֹרְט", "מַגָּפַיִם כְּחֻלִּים"], tier: .easy),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מָה עָשָׂה רֶקְס בַּגִּנָּה?", correctAnswer: "חָפַר בּוֹר", distractors: ["קָטַף פְּרָחִים", "רָדַף אַחֲרֵי חָתוּל", "יָשַׁן בַּשֶּׁמֶשׁ"], tier: .easy),
                BankQuestion(prompt: "מָה רֶקְס הֶחְבִּיא בַּבּוֹר?", correctAnswer: "עֶצֶם גְּדוֹלָה", distractors: ["כַּדּוּר", "נַעַל", "אֹכֶל שֶׁל חֲתוּלִים"], tier: .easy),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מָה הֵכִינָה אִמָּא לְעוֹמֶר?", correctAnswer: "שׁוֹקוֹ וְלֶחֶם עִם רִבָּה", distractors: ["מָרָק חַם", "פִּיצָה", "דַּיְסָה עִם דְּבַשׁ"], tier: .easy),
                BankQuestion(prompt: "מָתַי זֶה קָרָה?", correctAnswer: "בַּבֹּקֶר", distractors: ["בַּלַּיְלָה", "בַּצָּהֳרַיִם", "בָּעֶרֶב"], tier: .easy),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "לְאָן הָלַךְ טַל?", correctAnswer: "לַסִּפְרִיָּה", distractors: ["לַגַּן", "לַחֲנוּת", "לַבְּרֵכָה"], tier: .easy),
                BankQuestion(prompt: "עַל מָה הַסֵּפֶר שֶׁטַּל בָּחַר?", correctAnswer: "עַל דִּינוֹזָאוּרִים", distractors: ["עַל חָלָל", "עַל פִּירָטִים", "עַל כְּלָבִים"], tier: .easy),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מָתַי נָסְעָה הַמִּשְׁפָּחָה לַפִּיקְנִיק?", correctAnswer: "בְּיוֹם שִׁשִּׁי", distractors: ["בְּשַׁבָּת", "בְּיוֹם רִאשׁוֹן", "בַּחֹפֶשׁ הַגָּדוֹל"], tier: .medium),
                BankQuestion(prompt: "לְאָן הָלְכוּ הַנְּמָלִים?", correctAnswer: "אֶל הָעוּגָה", distractors: ["אֶל הָאֲבַטִּיחַ", "אֶל הַכָּרִיכִים", "אֶל הָעֵץ"], tier: .medium),
                BankQuestion(prompt: "מָה עָשְׂתָה הַמִּשְׁפָּחָה בַּסּוֹף?", correctAnswer: "הֶעֱבִירָה אֶת הַשְּׂמִיכָה לְמָקוֹם אַחֵר", distractors: ["נָסְעָה הַבַּיְתָה", "זָרְקָה אֶת הָעוּגָה", "רָדְפָה אַחֲרֵי הַנְּמָלִים"], tier: .medium),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "כַּמָּה זְמַן הִתְנַדְנְדָה הַשֵּׁן?", correctAnswer: "שָׁבוּעַ", distractors: ["יוֹם אֶחָד", "חֹדֶשׁ", "שָׁעָה"], tier: .medium),
                BankQuestion(prompt: "מָתַי נָפְלָה הַשֵּׁן?", correctAnswer: "כְּשֶׁרוֹנִי נָגְסָה בְּתַפּוּחַ", distractors: ["כְּשֶׁרוֹנִי צִחְצְחָה שִׁנַּיִם", "בְּזְמַן הַשֵּׁנָה", "בַּמִּשְׂחָק בַּחָצֵר"], tier: .medium),
                BankQuestion(prompt: "מָה מָצְאָה רוֹנִי מִתַּחַת לַכָּרִית?", correctAnswer: "מַטְבֵּעַ נוֹצֵץ", distractors: ["שֵׁן חֲדָשָׁה", "מַמְתָּק", "מִכְתָּב"], tier: .medium),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מִמָּה בָּנוּ אִיתַי וְשִׁירָה אֶת הָרוֹבּוֹט?", correctAnswer: "מִקֻּפְסָאוֹת", distractors: ["מִלֶּגוֹ", "מִפְּלַסְטֶלִינָה", "מִבַּרְזֶל"], tier: .medium),
                BankQuestion(prompt: "מָה יָדַע הָרוֹבּוֹט לְהַדְלִיק?", correctAnswer: "נוּרָה אֲדֻמָּה בָּאַף", distractors: ["פָּנָס בַּיָּד", "מָסָךְ קָטָן", "שְׁתֵּי עֵינַיִם יְרֻקּוֹת"], tier: .medium),
                BankQuestion(prompt: "בְּמָה זָכָה הָרוֹבּוֹט בַּתַּעֲרוּכָה?", correctAnswer: "בַּמָּקוֹם הָרִאשׁוֹן", distractors: ["בַּמָּקוֹם הַשֵּׁנִי", "בְּמֶדַלְיַת כֶּסֶף", "בְּפַרְס הַקְּהָל"], tier: .medium),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "בְּאֵיזֶה יוֹם דָּנִיאֵל עוֹזֵר לְסַבָּא?", correctAnswer: "בְּיוֹם שְׁלִישִׁי", distractors: ["בְּיוֹם שִׁשִּׁי", "בְּשַׁבָּת", "כָּל יוֹם"], tier: .medium),
                BankQuestion(prompt: "מָה שָׁתְלוּ הַשָּׁבוּעַ?", correctAnswer: "עַגְבָנִיּוֹת וּמְלָפְפוֹנִים", distractors: ["פְּרָחִים", "תַּפּוּחִים וַאֲגַסִּים", "תּוּת שָׂדֶה"], tier: .medium),
                BankQuestion(prompt: "לְפִי סַבָּא, מָה צְמָחִים צְרִיכִים?", correctAnswer: "שֶׁמֶשׁ, מַיִם וְסַבְלָנוּת", distractors: ["רַק מַיִם", "חֹשֶׁךְ וְקֹר", "מוּזִיקָה שְׁקֵטָה"], tier: .medium),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "בַּמָּה אָסְפָה עֲדִי צְדָפִים?", correctAnswer: "בְּדֶלִי כָּחֹל", distractors: ["בְּשַׂקִּית", "בְּכוֹבַע", "בְּדֶלִי אָדֹם"], tier: .medium),
                BankQuestion(prompt: "מָה קָרָה לְאַרְמוֹן הַחוֹל?", correctAnswer: "גַּל מָחַק אוֹתוֹ", distractors: ["יֶלֶד דָּרַךְ עָלָיו", "הוּא נִשְׁאַר עַד הָעֶרֶב", "הָרוּחַ פִּזְּרָה אוֹתוֹ"], tier: .medium),
                BankQuestion(prompt: "אֵיךְ הִרְגִּישָׁה עֲדִי בַּסּוֹף?", correctAnswer: "לֹא הִתְעַצְּבָה — תִּכְנְנָה לִבְנוֹת שׁוּב", distractors: ["בָּכְתָה כָּל הַדֶּרֶךְ", "כָּעֲסָה עַל הַיָּם", "פָּחֲדָה מֵהַגַּלִּים"], tier: .medium),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "אֵיזוֹ חַיָּה יֵשׁ לַכִּתָּה?", correctAnswer: "אֹגֶר", distractors: ["אַרְנָב", "תֻּכִּי", "דָּג זָהָב"], tier: .medium),
                BankQuestion(prompt: "מָה הֵכִינָה אֲבִיגַיִל לִצְנוֹן?", correctAnswer: "מִגְרַשׁ מִשְׂחָקִים מִגְּלִילֵי נְיָר", distractors: ["עוּגָה קְטַנָּה", "בַּיִת מִלֶּגוֹ", "סְוֶדֶר צֶמֶר"], tier: .medium),
                BankQuestion(prompt: "אֵיפֹה נִרְדַּם צְנוֹן?", correctAnswer: "בְּתוֹךְ גָּלִיל", distractors: ["בַּכְּלוּב", "עַל הַסַּפָּה", "בַּכִּיס שֶׁל אֲבִיגַיִל"], tier: .medium),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מָתַי יָצְאָה הַמִּשְׁפָּחָה לַטִּיּוּל?", correctAnswer: "בְּמוֹצָאֵי שַׁבָּת", distractors: ["בְּשִׁשִּׁי בַּבֹּקֶר", "בְּיוֹם רִאשׁוֹן", "בַּצָּהֳרַיִם"], tier: .hard),
                BankQuestion(prompt: "שֶׁל מִי הָיְתָה הַנְּבִיחָה הַמְּשֻׁנָּה?", correctAnswer: "שֶׁל תַּן", distractors: ["שֶׁל כֶּלֶב", "שֶׁל זְאֵב", "שֶׁל יַנְשׁוּף"], tier: .hard),
                BankQuestion(prompt: "מָה לִמֵּד אַבָּא עַל הַתַּן?", correctAnswer: "שֶׁהוּא מְפַחֵד מֵאִתָּנוּ יוֹתֵר מִשֶּׁאֲנַחְנוּ מִמֶּנּוּ", distractors: ["שֶׁהוּא מְסֻכָּן מְאוֹד", "שֶׁהוּא יָשֵׁן כָּל הַלַּיְלָה", "שֶׁהוּא אוֹהֵב פָּנָסִים"], tier: .hard),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מִמָּה מַתְחִילִים לְהָכִין לֶחֶם?", correctAnswer: "מִגַּרְגְּרֵי חִטָּה", distractors: ["מֵאֹרֶז", "מִתַּפּוּחֵי אֲדָמָה", "מִסֻּכָּר"], tier: .hard),
                BankQuestion(prompt: "לָמָּה הַבָּצֵק צָרִיךְ לָנוּחַ?", correctAnswer: "כְּדֵי לִתְפֹּחַ מִבּוּעוֹת הָאֲוִיר", distractors: ["כְּדֵי לְהִתְקָרֵר", "כְּדֵי לְהִתְיַבֵּשׁ", "כְּדֵי לְהַחְלִיף צֶבַע"], tier: .hard),
                BankQuestion(prompt: "מָה עוֹשִׂים לַגַּרְגְּרִים אַחֲרֵי הַקָּצִיר?", correctAnswer: "טוֹחֲנִים אוֹתָם לְקֶמַח", distractors: ["מְבַשְּׁלִים אוֹתָם", "צוֹבְעִים אוֹתָם", "שׁוֹתְלִים אוֹתָם שׁוּב"], tier: .hard),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מִי מָצָא אֶת גּוּר הַדּוֹלְפִינִים?", correctAnswer: "דַּיָּגִים", distractors: ["מְטַיְּלִים", "יְלָדִים", "מְצִילִים בַּבְּרֵכָה"], tier: .hard),
                BankQuestion(prompt: "לָמָּה שָׁמְרוּ שֶׁעוֹר הַדּוֹלְפִין יִשָּׁאֵר רָטֹב?", correctAnswer: "כִּי דּוֹלְפִין שֶׁמִּתְיַבֵּשׁ בְּסַכָּנָה", distractors: ["כְּדֵי שֶׁיִּהְיֶה לוֹ נָעִים", "כְּדֵי לְנַקּוֹת אוֹתוֹ", "כִּי הוּא אָהַב מַיִם קָרִים"], tier: .hard),
                BankQuestion(prompt: "מָתַי הֶחְזִירוּ אוֹתוֹ לַמַּיִם הָעֲמֻקִּים?", correctAnswer: "כְּשֶׁעָלָה הַגֵּאוּת", distractors: ["בַּלַּיְלָה", "מִיָּד כְּשֶׁמָּצְאוּ אוֹתוֹ", "אַחֲרֵי שֶׁאָכַל"], tier: .hard),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "אֵיפֹה מָצְאָה אֶלָּה אֶת הַשָּׁעוֹן?", correctAnswer: "בַּעֲלִיַּת הַגַּג", distractors: ["בַּמַּרְתֵּף", "בַּחֲנוּת עַתִּיקוֹת", "בַּגִּנָּה"], tier: .hard),
                BankQuestion(prompt: "אֵיךְ הִגִּיעַ הַשָּׁעוֹן לַמִּשְׁפָּחָה?", correctAnswer: "עִם סָבָא רַבָּא, בָּאֳנִיָּה", distractors: ["נִקְנָה בַּשּׁוּק", "הִתְקַבֵּל בְּמַתָּנָה מִשָּׁכֵן", "בְּמִכְתָּב מֵחוּץ לָאָרֶץ"], tier: .hard),
                BankQuestion(prompt: "לָמָּה זָלְגָה לְסָבְתָא דִּמְעָה?", correctAnswer: "כִּי לֹא שָׁמְעָה אֶת הַצִּלְצוּל מֵאָז יַלְדוּתָהּ", distractors: ["כִּי הַשָּׁעוֹן נִשְׁבַּר", "כִּי הִיא נֶחְתְּכָה בָּאֶצְבַּע", "כִּי הָאֹכֶל נִשְׂרַף"], tier: .hard),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "אֵיךְ דְּבוֹרָה מְסַפֶּרֶת עַל שָׂדֶה פְּרָחִים?", correctAnswer: "בְּרִקּוּד בְּצוּרַת שְׁמוֹנֶה", distractors: ["בְּזִמְזוּם חָזָק", "בִּנְגִיעָה בַּכְּנָפַיִם", "בְּהַשְׁאָרַת רֵיחַ"], tier: .hard),
                BankQuestion(prompt: "מָה מַרְאֶה כִּוּוּן הָרִקּוּד?", correctAnswer: "לְאֵיזֶה כִּוּוּן לָעוּף", distractors: ["כַּמָּה דְּבוֹרִים לָבוֹא", "אֵיזֶה צֶבַע לַפְּרָחִים", "מָתַי לָצֵאת"], tier: .hard),
                BankQuestion(prompt: "מָה מְסַפֶּרֶת מְהִירוּת הַנִּעְנוּעַ?", correctAnswer: "כַּמָּה רָחוֹק הַשָּׂדֶה", distractors: ["כַּמָּה צוּף יֵשׁ", "מָה מֶזֶג הָאֲוִיר", "מִי הַמַּלְכָּה"], tier: .hard),
            ]),
        ...
        ReadingPassage(
            ...
            questions: [
                BankQuestion(prompt: "מִמָּה נַעֲשָׂה שֶׁלֶד הָעֲפִיפוֹן?", correctAnswer: "מִקְּנֵי בַּמְבּוּק", distractors: ["מִבַּרְזֶל", "מִפְּלַסְטִיק", "מֵעֲנָפִים כְּבֵדִים"], tier: .hard),
                BankQuestion(prompt: "לָמָּה עֲפִיפוֹנִים רַבִּים צָנְחוּ?", correctAnswer: "כִּי כִּמְעַט לֹא הָיְתָה רוּחַ", distractors: ["כִּי יָרַד גֶּשֶׁם", "כִּי הַחוּטִים נִקְרְעוּ", "כִּי הָיָה חֹשֶׁךְ"], tier: .hard),
