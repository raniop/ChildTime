    ...
    static let passages: [ReadingPassage] = [
        ...
        ReadingPassage(
            ...
            questions: [
                ...
                BankQuestion(prompt: "מָתַי נָפְלָה הַשֵּׁן?", correctAnswer: "כְּשֶׁרוֹנִי נָגְסָה בְּתַפּוּחַ", distractors: ["כְּשֶׁרוֹנִי צִחְצְחָה שִׁנַּיִם", "בִּזְמַן הַשֵּׁנָה", "בַּמִּשְׂחָק בַּחָצֵר"], tier: .medium, grades: 2...4),
