...
enum QuestionBanksSea {
    static let sea: [BankQuestion] = [
        ...
        BankQuestion(prompt: "🐟\nאֵיפֹה חַיִּים דָּגִים?", correctAnswer: "בַּמַּיִם", distractors: ["בָּאֲוִיר", "עַל עֵצִים", "בַּמִּדְבָּר"], tier: .easy, grades: 0...0),
        ...
        BankQuestion(prompt: "🌡️\nאֵיפֹה מֵי הַיָּם חַמִּים יוֹתֵר — לְמַעְלָה, קָרוֹב לַשֶּׁמֶשׁ, אוֹ עָמֹק לְמַטָּה?", correctAnswer: "לְמַעְלָה", distractors: ["עָמֹק לְמַטָּה", "בְּדִיּוּק אוֹתוֹ דָּבָר", "בָּאֶמְצַע"], tier: .easy, grades: 1...2),
        ...
        BankQuestion(prompt: "🤿\nאֵיךְ קוֹרְאִים לְמִי שֶׁצּוֹלֵל מִתַּחַת לַמַּיִם עִם מַסֵּכָה וּבָלוֹן אֲוִיר?", correctAnswer: "צוֹלְלָן", distractors: ["טַיָּס", "נֶהָג", "שׁוֹעֵר"], tier: .easy, grades: 1...2),
        ...
        BankQuestion(prompt: "🦈\nמַהוּ הַכָּרִישׁ הַגָּדוֹל בְּיוֹתֵר בָּעוֹלָם, שֶׁאוֹכֵל רַק יְצוּרִים זְעִירִים?", correctAnswer: "כָּרִישׁ לִוְיָתָן", distractors: ["כָּרִישׁ לָבָן", "כָּרִישׁ פַּטִּישׁ", "כָּרִישׁ נָמֵר"], tier: .medium, grades: 2...4),
        ...
        BankQuestion(prompt: "🗺️\nמַה מְיֻחָד בְּיַם הַמֶּלַח?", correctAnswer: "הוּא הַמָּקוֹם הַנָּמוּךְ בָּעוֹלָם", distractors: ["הוּא הַיָּם הַגָּדוֹל בָּעוֹלָם", "הוּא הַיָּם הֶעָמֹק בָּעוֹלָם", "הוּא הַיָּם הַקַּר בָּעוֹלָם"], tier: .medium, grades: 3...4),
        ...
        BankQuestion(prompt: "🌙\nמַה גּוֹרֵם לַגֵּאוּת וְלַשֵּׁפֶל בַּיָּם?", correctAnswer: "הַיָּרֵחַ", distractors: ["הָרוּחַ", "הַדָּגִים", "הָעֲנָנִים"], tier: .medium, grades: 3...4),

        // ── בֵּינוֹנִי · צוֹלְלָנִים וְצוֹלְלוֹת ──
        BankQuestion(prompt: "🤿\nלָמָּה הַצּוֹלְלָן לוֹקֵחַ אִתּוֹ בָּלוֹן?", correctAnswer: "כְּדֵי לִנְשֹׁם מִתַּחַת לַמַּיִם", distractors: ["כְּדֵי לָצוּף לְמַעְלָה", "כְּדֵי לִשְׁתּוֹת מַיִם", "כְּדֵי לְהָאִיר בַּחֹשֶׁךְ"], tier: .medium, grades: 1...3),
        ...
        BankQuestion(prompt: "🦈\nמַה קוֹרֶה כְּשֶׁשֵּׁן שֶׁל כָּרִישׁ נוֹפֶלֶת?", correctAnswer: "צוֹמַחַת שֵׁן חֲדָשָׁה", distractors: ["נִשְׁאָר חוֹר לְתָמִיד", "הוּא מַפְסִיק לֶאֱכֹל", "הוּא הוֹלֵךְ לְרוֹפֵא שִׁנַּיִם"], tier: .hard, grades: 3...5),
