        ...
        case "138":
            return [
                Item(emoji: "🔒", title: "חלון משחק אחד — בכל המכשירים יחד",
                     line: "כשהילד פותח דקות באייפון, האייפד מראה שהחלון פתוח שם ומציע להעביר אותו לכאן. אותן דקות לא נפתחות פעמיים"),
                ...
                Item(emoji: "🕐", title: "שינוי שעון לא מזכה בזמן",
                ...
                Item(emoji: "💛", title: "יציב יותר, בטוח יותר",
                     line: "עשרות שיפורים שקטים לשמירה על ההתקדמות, הפרסים והדקות של הילדים בכל המכשירים"),
            ]
        case "137":
            return [
                Item(emoji: "🔒", title: "זמן המסך נאכף עכשיו בכל המכשירים יחד",
                     line: "המגבלה היומית נספרת פעם אחת לכל הילד — לא לכל מכשיר בנפרד. דקות מתנה ודקות שהורווחו כבר לא יכולות להיפתח פעמיים באייפד ובאייפון"),
