...
enum WhatsNewContent {
    ...
    static func items(for version: String) -> [Item]? {
        ...
        case "2026.9.1":
            return [
                Item(emoji: "💳", title: "רכישת טופי+ נרשמת מיד",
                     line: "אחרי אישור התשלום ב-App Store המנוי נפתח באותו רגע. קודם קרה שהתשלום עבר והאפליקציה עדיין הציגה את מסך הרכישה"),
                Item(emoji: "👪", title: "שם למשפחה כבר בהרשמה",
                     line: "משפחה חדשה נשאלת איך לקרוא לה, עם הצעה מוכנה משם החשבון — במקום להישאר \"תנו שם למשפחה\" במסך הראשי"),
                Item(emoji: "🚪", title: "מכשיר תקוע כבר לא תקוע",
                     line: "מכשיר שאיבד את הקשר למשפחה מציע לאפס את עצמו ולחזור למסך הפתיחה, בלי למחוק ולהתקין מחדש"),
                Item(emoji: "👑", title: "מסך טופי+ נכנס למסך אחד",
                     line: "כל מה שכלול, שני המסלולים והכפתור — בלי גלילה. ומנוי פעיל פותח את מסך ניהול המנוי של Apple"),
                ...
                Item(emoji: "👪", title: "שם למשפחה, וטופי+ במסך הראשי",
                     line: "לחיצה על הכותרת במסך ההורים נותנת שם למשפחה (\"משפחת גולן\"), והוא מופיע לכל ההורים. טופי+ עבר לכרטיס במסך הראשי, וההגדרות סודרו מחדש לשישה מסכים קצרים"),
                Item(emoji: "🪟", title: "עיצוב זכוכית חדש — בכל האפליקציה",
                     line: "כל מסך עבר לעיצוב זכוכית שקוף על רקע המותג: מסך הבית של הילד, השאלות, גלגל המזל, החנות, המטלות, הדירוג והטורניר — וגם מסך ההורים, הדוח לכל ילד, ההגדרות ומסך הרכישה. הכפתורים והכרטיסים אחידים, קריאים ורגועים יותר"),
                Item(emoji: "🌍", title: "כל עולם אפשר לפתוח גם ל־30 יום, בלי מנוי",
                     line: "לא רוצים מנוי קבוע? כל עולם בסיסי נפתח לילד אחד ל־30 יום בתשלום חד־פעמי, בלי חידוש אוטומטי. במסך ההורים יש מדף \"העולמות של טופי\", ובכל עמוד עולם שתי דרכים: רק העולם הזה, או טופי+ לכל המשפחה. 3 ימים לפני הסיום תקבלו תזכורת, וההתקדמות של הילד נשמרת"),
                Item(emoji: "⚽", title: "שאלונים חדשים לילדים — עולם הכדורגל ראשון",
                     line: "במסך ההורים יש עכשיו מדף \"שאלונים חדשים\": עולם שלם של שאלות בנושא שהילד אוהב. למנויי טופי+ הוא נפתח אוטומטית לכל הילדים; בלי מנוי בוחרים לאיזה ילד לשלוח, וברגע הבא הוא מקבל מתנה במסך הבית שלו. ילד שרוצה שאלון לוחץ \"בקש מאבא או אמא\" — בלי מחירים במכשיר של הילד"),
                Item(emoji: "🔊", title: "ההקראה אומרת קודם את המספר",
                     line: "\"מספר 1. קטן. מספר 2. …\" — עם הפסקה בין המספר לתשובה, כדי שילד שעוד לא קורא יבחר בקלות. ואם התקנתם את קול \"כרמית משופרת\" בהגדרות הנגישות, טופי משתמש בו"),
