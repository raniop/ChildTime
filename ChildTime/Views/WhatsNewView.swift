        ...
        case "2026.9.1":
            return [
                ...
                Item(emoji: "⚽", title: "שאלונים חדשים לילדים — עולם הכדורגל ראשון",
                     line: "במסך ההורים יש עכשיו מדף \"שאלונים חדשים\": עולם שלם של שאלות בנושא שהילד אוהב, כתוספת לטופי+. בוחרים לאיזה ילד לשלוח, וברגע הבא הוא מקבל מתנה במסך הבית שלו. ילד שרוצה שאלון לוחץ \"בקש מאבא או אמא\" — בלי מחירים במכשיר של הילד"),
